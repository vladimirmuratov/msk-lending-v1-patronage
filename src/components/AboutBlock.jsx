        ...
        >
            ...
            >
                <Box component="span" sx={{ color: 'var(--red)', fontWeight: 600 }}>Медицинская Сервисная Компания
                    (МСК)</Box> — частная организация, специализирующаяся на платной госпитализации
                и патронаже. Обеспечиваем высокий уровень медицинской помощи, предоставляя клиентам комфорт и внимание в
